      ...
      <CardBody>
        <Row>
          <Col sm='2' className='d-flex flex-column flex-wrap text-center text-nowrap'>
            <CardText>اطلاعات کاربران</CardText>
          </Col>
        </Row>
        <Row>
        ...
        <div className='d-flex justify-content-between'>
          <div className='text-center'>
            <CardText className='mb-50'>همه کاربران</CardText>
            <span className='font-large-1 fw-bold'>26</span>
          </div>
          <div className='text-center'>
            <CardText className='mb-50 fw-bold'>کاربران فعال</CardText>
            <span className='font-large-1 fw-bold'>19</span>
          </div>
          <div className='text-center'>
            <CardText className='mb-50 fw-bold'>کاربران غیر فعال</CardText>
