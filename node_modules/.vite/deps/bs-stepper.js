...
} from "./chunk-QNDYVOMK.js";

// node_modules/bs-stepper/dist/js/bs-stepper.js
var require_bs_stepper = __commonJS({
  "node_modules/bs-stepper/dist/js/bs-stepper.js"(exports, module) {
    init_virtual_process_polyfill();
    init_buffer();
    (function(global, factory) {
      ...
      var closest = function closest2(element, selector) {
        return element.closest(selector);
      };
      var WinEvent = function WinEvent2(inType, params) {
        return new window.Event(inType, params);
      };
      var createCustomEvent = function createCustomEvent2(eventName, params) {
      ...
      function polyfill() {
        ...
        if (!window.Element.prototype.closest) {
          closest = function closest2(element, selector) {
        ...
        if (!window.Event || typeof window.Event !== "function") {
          WinEvent = function WinEvent2(inType, params) {
            params = params || {};
        ...
        if (typeof window.CustomEvent !== "function") {
          ...
          createCustomEvent = function createCustomEvent2(eventName, params) {
      ...
      var show = function show2(stepperNode, indexStep, options, done) {
      ...
      var showStep = function showStep2(stepperNode, step, stepList, options) {
        stepList.forEach(function(step2) {
          var trigger = step2.querySelector(options.selectors.trigger);
      ...
      var showContent = function showContent2(stepperNode, content, contentList, activeContent, done) {
        var stepper = stepperNode[customProperty];
      ...
      var getTransitionDurationFromElement = function getTransitionDurationFromElement2(element) {
        if (!element) {
          return 0;
        }
      ...
      var emulateTransitionEnd = function emulateTransitionEnd2(element, duration) {
        var called = false;
      ...
      var detectAnimation = function detectAnimation2(contentList, options) {
      ...
      var buildClickStepLinearListener = function buildClickStepLinearListener2() {
        return function clickStepLinearListener(event) {
          event.preventDefault();
        };
      };
      var buildClickStepNonLinearListener = function buildClickStepNonLinearListener2(options) {
      ...
      var Stepper = function() {
        function Stepper2(element, _options) {
          var _this = this;
          if (_options === void 0) {
            _options = {};
          }
        ...
        _proto.destroy = function destroy() {
          ...
          this._element[customProperty] = void 0;
...
export default require_bs_stepper();
/*!
